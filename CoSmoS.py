...
from numpy import linspace, sqrt, log, arange, exp, sin, sinh
...
def Time(a, b):
    '''a is the time at the emission (t_e), b is the time at the observation (t_0). I used the Simpsons rule'''
    h = (b - a) / N
